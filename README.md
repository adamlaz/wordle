# Wordle Clone -> Insur-dle

> this is a fork of the open-source clone that uses words that are related to the insurance industry.

- Go play the real Wordle [here](https://www.powerlanguage.co.uk/wordle/)
- Read the story behind it [here](https://www.nytimes.com/2022/01/03/technology/wordle-word-game-creator.html)
- Try a demo of this clone project [here](https://insurdle.netlify.app/)
